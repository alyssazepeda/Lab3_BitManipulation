 ...
 *	Exercise Description: In addition to the above, PA4 is 1 if a
 *	key is in the ignition, PA5 is one if a driver is seated, and
 *	PA6 is 1 if the driver's seatbelt is fastened. PC7 should light
 *	a "Fasten seatbelt" icon if a key is in the ignition, the 
